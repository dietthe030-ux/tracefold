...
| T01 | `tf5-t01-propose-alias`; `propose_alias_set("tf4-alias","CVE-2024-26130","","PYSEC-2024-225")` | Proposal 1 PROPOSED; exact IDs/nonce; `created_at` equals the transaction timestamp. |
...
| T03P | `tf5-t03p-propose-cluster2`; `propose_alias_set("tf4-cluster2","CVE-2023-41335","","PYSEC-2023-185")` | Proposal 2 PROPOSED with exact IDs. |
| T03A | `tf5-t03a-assess-cluster2`; `assess_proposal(2)` | SAME/MERGED; cluster 2 exact aliases; cluster 1 unchanged. |
| T04 | `tf5-t04-cross-conflict`; `propose_alias_set("tf4-cross","CVE-2024-26130","","PYSEC-2023-185")` | Proposal 3 CONFLICT with `[1,2]`; both clusters unchanged. |
| T05 | `tf5-t05-objection-proposal`; `propose_alias_set("tf4-objection","CVE-2022-40897","","PYSEC-2022-43012")` | Proposal 4 PROPOSED, zero objections. |
...
| T08 | `tf5-t08-unavailable-proposal`; `propose_alias_set("tf4-unavailable","CVE-2099-99999999")` | Proposal 5 PROPOSED with no cluster. |
...
| T12 | `tf5-t12-distinct-proposal`; `propose_alias_set("tf4-distinct","CVE-2021-45046","","PYSEC-2022-43012")` | Proposal 6 PROPOSED; clusters unchanged. |
...
| T14 | `tf5-t14-consume`; `consume_incident("tf4-incident-001","1")` | True; consumption 1 has exact caller/context/cluster and receipt-bound time. |
