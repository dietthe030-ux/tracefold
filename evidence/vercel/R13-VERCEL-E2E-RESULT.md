...
The successful transaction ran on `a11771f5b47d9d1fd844b4a6ed41e774ed586859`. The final release changes after that revision affect presentation, notice UX, accessibility, tests, and the hero image only. `rpcClient.ts`, `pendingTxStore.ts`, and `ProposeAliasSet.tsx` remain byte-identical, so the transaction proof remains applicable to `f757ef5`.
...
The machine-readable result is [`R13-VERCEL-E2E-RESULT.json`](R13-VERCEL-E2E-RESULT.json).
