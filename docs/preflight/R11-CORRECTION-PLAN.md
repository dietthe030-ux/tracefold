...
Verification: 27 DirectVM tests pass, including the authoritative timestamp regression; `genvm-lint 0.11.1rc2` passes all three checks and exposes the unchanged 20-method schema; live `getContractSchemaForCode` passes on Studio Dev chain 61997.
